...
var toolinfo = {"tool_namespace":"fhg",
"tool_name_en":"Feihua generator",
"tool_name_zh_cn":"废话生成器","tool_infomation_en":"Generator chinese Feihua","tool_infomation_zh_cn":"生成废话"}
console.log("%cWANGYUPU TOOLS%c\nFeihua Generator %cONLINE%c -w-","font-family: Ubuntu,system-ui,-apple-system,sans-serif;font-weight:bold;font-size:500%;color:#00ffff",
...
console.group("wangyupu tools · 工具  FHG 详细信息")
console.log("wangyupu tools · 工具  FHG 详细信息")
...
function random_random(minNum,maxNum){ 
...
function randomanfeihua() {
    var method = choiceitem([1,2,3]);
    var total = random_random(1,45)
    function idkwhatthisname(dict,total){
        item = choiceitem(dict)
...
function button_callback(){
    if (loadsuccess) {
        document.getElementById("content").value=randomanfeihua();
    }
}
