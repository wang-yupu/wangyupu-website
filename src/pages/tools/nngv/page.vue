...
<template>
    <div class="nng">
        <el-affix position="top" :offset="20">
            <iframe frameborder="yes" border="0" marginwidth="0" marginheight="0" width=280 height=52 src="//music.163.com/outchain/player?type=2&id=4010201&auto=1&height=32"></iframe>
        </el-affix>
        <h1>网易MC名称生成器</h1>
        <h1>输入你的名称</h1>

        <el-input class="input" v-model="name" size="large" maxlength="12">
            <template #suffix><el-button size="large" @click="button_click"><img src="/src/assets/icons/dice_0.png"></el-button></template>
        </el-input>
        
        <button class="nng_button" ><img src="/src/assets/icons/red_cross.png"></button>
    </div>


    <!-- DIALOG -->
    <!-- <el-dialog v-model="badwordDialog" title="Warning" width="500" center>
    <span>
        名称含有违禁词
    </span>
    <template #footer>
        <el-button type="primary" @click="badwordDialog = false">
            确定
        </el-button>
    </template>
    </el-dialog> -->
