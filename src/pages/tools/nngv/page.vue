    ...
    <div class="nng">
        <div class="content">
            ...
            <div class="footer">
                ...
                <iframe class="mp" :width="windowWidth * 0.9" height="50" src="//music.163.com/outchain/player?type=2&id=4010201&height=32"></iframe>
                <div class="infomations">
                    <div>
                        <img src="/src/assets/nng/info.png" height="50" />
                        <div>
                            <span>词库从网易MC(安卓)中提取</span>
                            <span>违禁词检测未实现（欢迎PR）</span>
                        </div>
                    </div>
                    <div>
...
.mp {
    background: conic-gradient(#ff00ff 0.25turn, #000 0.25turn 0.5turn, #ff00ff 0.5turn 0.75turn, #000 0.75turn) top left / 15px 15px repeat;
